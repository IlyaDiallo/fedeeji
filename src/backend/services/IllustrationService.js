...
const SYNONYMS = {
    ...
    toit: ['feddeeji-roof'],
    toits: ['feddeeji-roof'],
    toiture: ['feddeeji-roof'],
    toitures: ['feddeeji-roof'],
    camion: ['truck', 'truck-delivery', 'truck-loading'],
    camions: ['truck', 'truck-delivery', 'truck-loading'],
    maison: ['home', 'building-cottage'],
    maisons: ['home', 'building-cottage'],
    porte: ['door', 'door-enter'],
    portes: ['door', 'door-enter'],
    fenetres: ['window'],
    canape: ['sofa'],
    canapes: ['sofa'],
    fauteuil: ['armchair', 'armchair-2'],
    fauteuils: ['armchair', 'armchair-2'],
    lampe: ['lamp', 'lamp-2'],
    lampes: ['lamp', 'lamp-2'],
    escalier: ['stairs'],
    escaliers: ['stairs'],
    aspirateurs: ['vacuum-cleaner'],
    bain: ['bath'],
    bains: ['bath'],
    baignoire: ['bath'],
...
const LOCAL_LABELS = {
    fr: {
        bed: 'Lit', 'bed-flat': 'Lit plat', 'feddeeji-roof': 'Toit',
        truck: 'Camion', 'truck-loading': 'Chargement du camion',
        home: 'Maison', 'building-cottage': 'Maison de campagne',
        door: 'Porte', 'door-enter': 'Entrée', sofa: 'Canapé',
        armchair: 'Fauteuil', 'armchair-2': 'Fauteuil',
        lamp: 'Lampe', 'lamp-2': 'Lampe', stairs: 'Escalier',
